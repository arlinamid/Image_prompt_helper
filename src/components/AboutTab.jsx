  ...
  return (
    <div className="about-tab">
      ...
      <div className="about-hero">
        ...
        <p className="version">Version 1.3.1</p>
      ...
      <section className="about-section">
        ...
        <ul className="feature-list">
          ...
          <li>
            <span className="feature-icon"><Dices size={20} /></span>
            <div>
              <strong>Prompt Variations</strong>
              <p>Generate creative variations for your ideas</p>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="about-section">
        <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Key size={24} /> AI Enhancement Setup
        </h2>
      ...
      <footer className="about-footer">
        <p>Made with <Heart size={14} fill="currentColor" style={{ display: 'inline', verticalAlign: 'middle' }} /> for the AI Art community</p>
